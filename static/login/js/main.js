$(document).ready(function () {
    ...
    const sidebar = function () {
        ...
        // Accordion
        $('.accordion-menu li a').on('click', function (_e) {
            let sub_menu = $(this).next('ul'), parent_list_el = $(this).parent('li'),
                active_list_element = $('.accordion-menu > li.open'), show_sub_menu = function () {
